...
public class SquareNumbers {
	...
	public static void main(String[] args) {
		// square root of Long.MAX_VALUE in the string format without decimal point
		String squareRootOfMaxLong = String.format("%.0f",Math.sqrt(Long.MAX_VALUE));
		BigInteger number = new BigInteger(squareRootOfMaxLong);//BigInteger with the value of Long.MAX_VALUE
		...
		while (count < 10) {
			...
			//if the squared number is greater than max long
			if(numberSquared.compareTo(maxLong) >=0){
